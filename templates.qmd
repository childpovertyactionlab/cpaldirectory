...
```{=html}
 <iframe id="example1" src="https://gallery.shinyapps.io/goog-trend-index/" style="border: none; width: 100%; height: 430px" frameborder="0"></iframe>
```
...
![staticweb](graphics/ss-internal-dashboard.jpeg)
